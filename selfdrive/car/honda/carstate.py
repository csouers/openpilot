...
def get_can_signals(CP):
  ...
  if CP.carFingerprint in HONDA_BOSCH:
    ...
    if CP.carFingerprint not in (CAR.ACCORDH, CAR.ACCORDH_21, CAR.CIVIC_BOSCH, CAR.CIVIC_BOSCH_DIESEL, CAR.CRV_HYBRID, CAR.INSIGHT):
  ...
  if CP.carFingerprint in (CAR.ACCORD, CAR.ACCORD_21, CAR.ACCORD_15, CAR.ACCORDH, CAR.ACCORDH_21, CAR.CIVIC_BOSCH, CAR.CIVIC_BOSCH_DIESEL, CAR.CRV_HYBRID, CAR.INSIGHT, CAR.ACURA_RDX_3G):
...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam, cp_body):
    ...
    if self.CP.carFingerprint in (CAR.ACCORD, CAR.ACCORD_21, CAR.ACCORD_15, CAR.ACCORDH, CAR.ACCORDH_21, CAR.CIVIC_BOSCH, CAR.CIVIC_BOSCH_DIESEL, CAR.CRV_HYBRID, CAR.INSIGHT, CAR.ACURA_RDX_3G):
    ...
    if self.CP.carFingerprint in (CAR.CIVIC, CAR.ODYSSEY, CAR.CRV_5G, CAR.ACCORD, CAR.ACCORD_21, CAR.ACCORD_15, CAR.ACCORDH, CAR.ACCORDH_21, CAR.CIVIC_BOSCH,
    ...
    if self.CP.carFingerprint in HONDA_BOSCH:
      ...
      if self.CP.carFingerprint in (CAR.CIVIC_BOSCH, CAR.CIVIC_BOSCH_DIESEL, CAR.ACCORDH, CAR.ACCORDH_21, CAR.CRV_HYBRID, CAR.INSIGHT):
